...
public class UserInfoDao {
	...
	public static class CreateUserInfo extends Db {
	...
	public static class ReadUserInfo extends Db {
	...
	public static class DeleteUserInfo extends Db {
	...
	public static class UpdateUserInfo extends Db {
