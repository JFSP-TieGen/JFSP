...
public class ServiceProviderInfoDao {
	public static class CreateServiceProviderInfo extends Db {
	...
	public static class ReadServiceProviderInfo extends Db {
	...
	public static class DeleteServiceProviderInfo extends Db {
	...
	public static class UpdateServiceProviderInfo extends Db {
