...
public class BookingDao {
	public static class CreateBooking extends Db {
	...
	public static class ReadBooking extends Db {
	...
	public static class DeleteBooking extends Db {
	...
	public static class UpdateBooking extends Db {
